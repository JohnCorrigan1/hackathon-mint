...
const PlayerListItem: React.FC<{name: string, class: string, level: string, tokenId: string, address: string}> = (props) => {
    ...
    return (
            ...
            <p className="w-full flex justify-center text-xl"><Link href={`/${props.address}/${props.tokenId}`}><button className="p-2 bg-cyan-600 rounded-lg w-1/2 hover:bg-cyan-700 active:scale-95 duration-200">Edit</button></Link></p>
